    ...
    public function getAll()
   {
      ...
      return Datatables::of($users)
        ...
        ->addColumn('action', function ($user)  {
           ...
           $html .= '<a data-toggle="tooltip" '  . '  id="' . $user->id . '" class="btn btn-xs btn-info mr-1 edit" title="Edit" style="color:white"><i class="fa fa-edit"></i> </a>';
           $html .= '<a data-toggle="tooltip" '  . ' id="' . $user->id . '" class="btn btn-xs btn-danger mr-1 delete" title="Delete" style="color:white"><i class="fa fa-trash"></i> </a>';
           $html .= '</div>';
           return $html;
        })
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax()) {
               $roles = Role::all();
               $view = View::make('backend.user-management.users.create', compact('roles'))->render();
    ...
    public function edit(Request $request,User $user)
    {
        ...
        if ($request->ajax()) {
              $user->load('roles');
               ...
               $view = View::make('backend.user-management.users.edit', compact('user', 'roles'))->render();
               return response()->json(['html' => $view]);
