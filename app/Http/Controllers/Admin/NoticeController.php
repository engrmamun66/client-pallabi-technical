...
class NoticeController extends Controller
{
    public function index()
    {
        ...
        return view('backend.notice-management.index');
    }

    public function getAll()
   {

      $notices = Notice::where('status','notice')->get();
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax()) {
               $view = View::make('backend.notice-management.create')->render();
    ...
    public function edit(Request $request,Notice $notice)
    {
        ...
        if ($request->ajax()) {
               $view = View::make('backend.notice-management.edit', compact('notice'))->render();
               return response()->json(['html' => $view]);
    ...
    public function show(Notice $notice)
    {
        ...
        return view('backend.notice-management.show', compact('notice'));
    }
