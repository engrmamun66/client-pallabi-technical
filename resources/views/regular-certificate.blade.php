        ...
        <div class="certificate">
            ...
            <div class="content mt-4">
                ...
                <p style="margin-bottom: 10px;">
                    ...
                    <span style="display: inline-block; width: 200px;"></span><span style="margin-bottom: 40px">: <strong>{{ $certificate?->course->course_name }} {{ $certificate?->mark_obtained }} Position</strong></span>
                </p>
                <p style="margin-bottom: 10px; display: flex;">
            ...
            <table style="width: 100%; margin-top: 120px;">
                <tr>
                    <td style="text-align: start;">
                        <img src="{{ public_path('assets/images/certificate/training.jpg') }}" style="height: 40px; margin-left: 25px" /><br>
                        Training Manager
                    </td>
                    <td style="text-align: right;">
                        <img src="{{ public_path('assets/images/certificate/director.png') }}" style="height: 40px;" /><br>
                        <span style="margin-right: 15px !important">Director</span>
                    </td>
                </tr>
            </table>
