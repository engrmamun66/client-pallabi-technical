<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    <div class="form-row">
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <input type="text" class="form-control" id="title" name="title" value="{{ $admission->title }}"
                placeholder="">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <div class="input-group">
                ...
                <input type="text" name="SelectedFileName" class="form-control" id="SelectedFileName"
                    value="{{ $admission->image }}" readonly>
            </div>
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <textarea name="description" id="description" cols="30" rows="10">{!! $admission->description !!}</textarea>
            <span id="error_title" class="has-error"></span>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#edit').validate({ // <- attach '.validate()' to your form
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: 'admission-sections/' + '{{ $admission->id }}',
                    type: 'POST',
                    data: myData,
                    dataType: 'json',
                    cache: false,
