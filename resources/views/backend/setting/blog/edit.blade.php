<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8"
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" id="title" value="{{ $blog->title }}" name="title" value="" placeholder="title"
                required>
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="SelectedFileName" class="form-control" id="SelectedFileName" value="{{ $blog->image }}"
                    readonly>
            </div>
