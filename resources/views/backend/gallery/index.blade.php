    ...
    <script>
        $(function() {
            ...
            table = $('#manage_all').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": '{!! route('admin.allGallery.galleries') !!}',
                    "type": "GET",
                    headers: {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#manage_all").on("click", ".view", function() {
                var id = $(this).attr('id');
                ajax_submit_view('galleries', id)
            });

            // Edit Form
            $("#manage_all").on("click", ".edit", function() {
                var id = $(this).attr('id');
                ajax_submit_edit('galleries', id)
            });
            ...
            $("#manage_all").on("click", ".delete", function() {
                var id = $(this).attr('id');
                ajax_submit_delete('galleries', id)
            });
