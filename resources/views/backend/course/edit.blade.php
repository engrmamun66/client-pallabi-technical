    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6 col-sm-12">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="duration" name="duration" value="{{ $course->duration }}" placeholder=""
                    required>
                <div class="input-group-append">
                    <select class="form-control" id="duration_unit" name="duration_type" required>
                        <option value="week" {{ $course->duration_type == 'week' ? 'selected' : '' }}>Week</option>
                        <option value="month" {{ $course->duration_type == 'month' ? 'selected' : '' }}>Month</option>
                        <option value="year" {{ $course->duration_type == 'year' ? 'selected' : '' }}>Year</option>
                    </select>
                </div>
            </div>
            <span id="error_name" class="has-error"></span>
        ...
        <div class="form-group col-md-6 col-sm-6">
            <label for="site_logo">image (File must be jpg, jpeg, png)</label>
            <div class="input-group">
