    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Pallabi Technical Institute and Organization
                    <div class="page-title-subheading">This is a dashboard for PTIO.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="card mb-3 widget-content bg-midnight-bloom">
                <div class="widget-content-wrapper text-white">
                    ...
                    <div class="widget-content-right">
                        @php
                            $totalCourse = \App\Models\Course::count();
                        @endphp
                        <div class="widget-numbers text-white"><span>{{ $totalCourse }}</span></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-4">
            <div class="card mb-3 widget-content bg-arielle-smile">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        <div class="widget-heading">Total Certificate</div>
                    </div>
                    <div class="widget-content-right">
                        @php
                            $totalCertificate = \App\Models\Certificate::count();
                        @endphp
                        <div class="widget-numbers text-white"><span>{{ $totalCertificate }}</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Today Task
