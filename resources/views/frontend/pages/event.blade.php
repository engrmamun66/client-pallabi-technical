            ...
            <div class="col-md-12 col-12">
                <div class="page-heading text-white">
                    <div class="page-title">
                        <h1 style="font-size: 50px">Event Page</h1>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="blog-posts">
                    ...
                    <div class="single-blog-post">
                        <div class="post-featured-thumb bg-cover" style="background-image: url('{{ asset('public/'.$event->image) }}');background-size: contain !important;"></div>
